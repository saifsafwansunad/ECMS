...
public class PrivateAdapter_frag extends RecyclerView.Adapter<PrivateAdapter_frag.ViewHolder> {
    ...
    public PrivateAdapter_frag(List<CommitteeFilesResponse.FileSy> folderList, Context context,PrivateFragment fragment) {
    ...
    @NotNull
    @Override
    public PrivateAdapter_frag.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.layout_for_committee_folder, parent, false);
        return new PrivateAdapter_frag.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull PrivateAdapter_frag.ViewHolder holder, int position) {
