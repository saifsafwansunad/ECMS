...
public class PublicFragment extends Fragment implements View.OnClickListener, myDialog.DialogListener {
    ...
    PublicFolderAdapter folderAdapter;
...
//        Toast.makeText(this, Uri, Toast.LENGTH_SHORT).show();
        ...
        PublicFragment.Downloaddialog downloaddialog = new PublicFragment.Downloaddialog();
...
//        Toast.makeText(AppointmentsActivity.this, "appointments got", Toast.LENGTH_LONG).show();
                            ...
                            if (response.body() != null) {
                                ...
                                cf_folder_rv.setAdapter(new PublicAdapter_frag(folderList, getContext(),PublicFragment.this));
