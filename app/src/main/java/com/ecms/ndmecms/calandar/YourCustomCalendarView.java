...
public class YourCustomCalendarView extends LinearLayout {
    ...
    public YourCustomCalendarView(Context context) {
        super(context);
    }

    public YourCustomCalendarView(final Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//                    return true;
    ...
    public YourCustomCalendarView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
