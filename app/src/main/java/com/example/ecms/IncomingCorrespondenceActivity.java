...
public class IncomingCorrespondenceActivity extends AppCompatActivity {
...
Chip chipInProgress,chipApproval;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_incoming_correspondence);
...
AddCorrespondenceDialog addCorrespondenceDialog=new AddCorrespondenceDialog();
addCorrespondenceDialog.showDialog(IncomingCorrespondenceActivity.this,"");
            }
        });

        ActionBar actionBar=getSupportActionBar();
        actionBar.hide();
        toolbar.setTitle("Incoming Correspondence");
...
//        toolbar.setTitleTextColor(Color.parseColor("#000"));
        ...
        IncomingCorrespondenceAdapter incomingCorrespondenceAdapter=new IncomingCorrespondenceAdapter(incomingCorrepondenceObjectsArrayList,IncomingCorrespondenceActivity.this);
...
//            dialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
            ...
            ArrayAdapter<String> departmentadapter = new ArrayAdapter<String>(IncomingCorrespondenceActivity.this, android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.Deapartment));
            ArrayAdapter<String> sourceadapter = new ArrayAdapter<String>(IncomingCorrespondenceActivity.this, android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.Deapartment));
            ArrayAdapter<String> docthruadapter = new ArrayAdapter<String>(IncomingCorrespondenceActivity.this, android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.Document_Through));
            ArrayAdapter<String> doctypeadapter = new ArrayAdapter<String>(IncomingCorrespondenceActivity.this, android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.Document_Type));
            ArrayAdapter<String> priorityadapter = new ArrayAdapter<String>(IncomingCorrespondenceActivity.this, android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.Priority));
